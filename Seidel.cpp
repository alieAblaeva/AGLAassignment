...
int main() {
    ...
    Matrix B(a.getSize(), a.getSize());
    Matrix C(a.getSize(), a.getSize());
    ...
    Matrix BAugmented = B.augmented();
    Matrix BInversed = Inversed(&BAugmented);
    Matrix alpha = i - dInversed*a;
    Matrix beta = dInversed*b;
    Matrix x = beta;


    Matrix B1(a.getSize(), a.getSize());
    Matrix C1(a.getSize(), a.getSize());
    for(int i =0; i<a.getSize(); i++){
        for(int j = 0; j<a.getSize(); j++){
            if(i>j){
                B1.elements[i][j] = alpha.elements[i][j];
                C1.elements[i][j] = 0;
            } else {
                B1.elements[i][j] = 0;
                C1.elements[i][j] = alpha.elements[i][j];
            }
        }
    }
    ...
    Matrix iB = i - B1;
    Matrix iBAugmented = iB.augmented();
    Matrix iBInversed = Inversed(&iBAugmented);
